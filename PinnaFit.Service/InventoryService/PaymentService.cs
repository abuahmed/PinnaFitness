...
namespace PinnaFit.Service
{
    public class PaymentService : IPaymentService
    {
        ...
        public IRepositoryQuery<PaymentDTO> Get()
        {
            var piList = _paymentRepository
                ...
                .Include(c => c.Warehouse,
                         c => c.Transaction, 
                         c => c.BusinessPartner,
                         c => c.Transaction.BusinessPartnerD,
        ...
        public string Validate(PaymentDTO payment)
        {
            ...
            if (String.IsNullOrEmpty(payment.PersonName) && payment.BusinessPartnerId==null)
                return "Receiver " + GenericMessages.StringIsNullOrEmpty;
