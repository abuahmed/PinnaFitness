...
namespace PinnaFit.WPF.Views
{
    ...
    /// </summary>
    public partial class MemberEntry : Window
    {
        public MemberEntry()
        {
        ...
        public MemberEntry(MemberTypes businessPartnerType)
        {
            MemberViewModel.Errors = 0;
            InitializeComponent();
        ...
        {
            if (e.Action == ValidationErrorEventAction.Added) MemberEntryViewModel.Errors += 1;
            if (e.Action == ValidationErrorEventAction.Removed) MemberEntryViewModel.Errors -= 1;
        }
