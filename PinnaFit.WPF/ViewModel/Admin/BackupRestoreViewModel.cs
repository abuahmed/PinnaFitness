...
namespace PinnaFit.WPF.ViewModel
{
    public class BackupRestoreViewModel : ViewModelBase
    {
        ...
        //    if (Singleton.Edition == PinnaFitEdition.ServerEdition)
        //    {
        ...
        //            var destFileName = "PinnaFitDb_" + DateTime.Now.ToLongDateString() + "_Backup.sdf";
        ...
        //                    var pathfile = Path.Combine(path, "PinnaFitDb_" + DateTime.Now.Ticks.ToString() + ".sdf");
        ...
        //                    var bkpDatabase = new Backup { Action = BackupActionType.Database, Database = "PinnaFitDb" };
        ...
        //            {
        //                //this.Cursor = Cursors.WaitCursor;                            
        //                var rstDatabase = new Restore { Action = RestoreActionType.Database, Database = "PinnaFitDb" };
